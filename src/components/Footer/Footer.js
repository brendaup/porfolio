...
export function Footer (){
    return(
        <div className='container-social'>
            <IconButton href='https://github.com/brendaup?tab=repositories'>
            ...
            <IconButton href='www.linkedin.com/in/brenda-armero'>
                <SvgIcon sx={{ fontSize: 30 }}>
            ...
            <IconButton href='https://twitter.com/rubideveloper'>
                <SvgIcon sx={{ fontSize: 30 }}>
